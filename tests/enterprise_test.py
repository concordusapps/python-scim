    ...
    def setUp(self):
        ...
        self.u.enterprise = (
            enterprise.Enterprise.Enterprise(
                ...
                department="hr",
                manager=enterprise.Enterprise.Enterprise.Manager(
                    manager_id='3',
                    name='adam'
                )
            )
